      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 px-6 pb-28 pt-8 sm:px-8 lg:grid-cols-12 lg:gap-10">
        <div className="lg:col-span-8">
          ...
          <SectionReveal delay={0.1} className="mt-14">
            <h2 className="font-display text-2xl text-espresso">{dict.tutorProfile.aboutTitle}</h2>
          ...
          <SectionReveal delay={0.15} className="mt-12">
            <h2 className="font-display text-2xl text-espresso">{dict.tutorProfile.methodologyTitle}</h2>
            <p className="mt-4 text-sm leading-relaxed text-espresso/70">{tutor.methodology}</p>
          </SectionReveal>

          <SectionReveal delay={0.2} className="mt-12">
            <h2 className="font-display text-2xl text-espresso">{dict.tutorProfile.suitableForTitle}</h2>
          ...
          <SectionReveal delay={0.3} className="mt-12">
            <h2 className="font-display text-2xl text-espresso">{dict.tutorProfile.videoTitle}</h2>
          ...
          <SectionReveal delay={0.35} className="mt-12">
            <h2 className="font-display text-2xl text-espresso">{dict.tutorProfile.reviewsTitle}</h2>
          ...
          <SectionReveal delay={0.4} className="mt-12">
            <h2 className="font-display text-2xl text-espresso">{dict.tutorProfile.scheduleTitle}</h2>
            <p className="mt-4 text-sm leading-relaxed text-espresso/70">{dict.tutorProfile.scheduleText}</p>
          </SectionReveal>
        </div>
