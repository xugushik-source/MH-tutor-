  ...
  return (
    <section className="bg-cream-dim py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 sm:px-8">
        ...
        <StaggerReveal className="mt-16 grid grid-cols-1 gap-4 rounded-[2rem] border border-ink/10 bg-cream p-4 shadow-2xl shadow-ink/10 sm:p-6 lg:grid-cols-12">
          <div className="flex flex-col gap-4 lg:col-span-8">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="relative aspect-[4/5] overflow-hidden rounded-2xl">
                ...
                />
                <span className="absolute bottom-3 left-3 rounded-full bg-ink/70 px-3 py-1 text-xs text-cream">
            ...
            <div className="flex items-center justify-center gap-3 rounded-2xl border border-ink/10 bg-sage-soft/50 py-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-ink/5 text-ink/60">
            ...
            <div className="rounded-2xl border border-ink/10 bg-sage-soft/50 p-5">
              ...
              <p className="mt-2 text-sm text-ink/50">{dict.classExperience.materialsExample}</p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 lg:col-span-4">
            <div className="rounded-2xl border border-ink/10 bg-sage-soft/50 p-5">
              ...
              <p className="mt-2 text-sm italic text-ink/50">{dict.classExperience.notesExample}</p>
            </div>

            <div className="rounded-2xl border border-ink/10 bg-sage-soft/50 p-5">
              <p className="flex items-center gap-2 text-sm font-medium text-ink/70">
                <ListChecks className="h-4 w-4 text-forest" />
                {dict.classExperience.homework}
              </p>
              <ul className="mt-2 flex flex-col gap-1.5 text-sm text-ink/55">
            ...
            <div className="rounded-2xl border border-ink/10 bg-sage-soft/50 p-5">
              ...
              <p className="mt-2 text-xs text-ink/45">{dict.classExperience.progressExample}</p>
            </div>
          </div>
        </StaggerReveal>
      </div>
