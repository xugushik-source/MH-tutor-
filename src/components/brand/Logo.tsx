 ...
 * re-rendered as a transparent PNG in both tones (forest for light
 ...
 * ratio automatically.
 */
export function LogoMark({ className, tone = "forest", priority }: LogoMarkProps) {
  const src = tone === "cream" ? "/brand/mh-monogram-cream.png" : "/brand/mh-monogram-forest.png";
