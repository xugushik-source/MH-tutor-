...
const hy: Dictionary = {
  ...
  dashboard: {
    nav: {
      overview: "Ընդհանուր",
      students: "Աշակերտներ",
      newHomework: "Նոր առաջադրանք",
      signOut: "Դուրս գալ",
    },
    login: {
      title: "Մուտք ուսուցիչների համար",
      subtitle: "Ստեղծեք և ստուգեք աշակերտների տնային առաջադրանքները։",
      signInTab: "Մուտք",
      signUpTab: "Ստեղծել հաշիվ",
      fullNameLabel: "Անուն, ազգանուն",
      emailLabel: "Email",
      passwordLabel: "Գաղտնաբառ",
      signInButton: "Մուտք",
      signUpButton: "Ստեղծել հաշիվ",
      pending: "Խնդրում ենք սպասել…",
      errorEmailPassword: "Մուտքագրեք email և գաղտնաբառ։",
      errorName: "Մուտքագրեք անունը։",
      errorEmail: "Մուտքագրեք email հասցեն։",
      errorPasswordLength: "Գաղտնաբառը պետք է լինի առնվազն 8 նիշ։",
      confirmEmailInfo:
        "Հաշիվը ստեղծված է․ հաստատեք email հասցեն նամակի հղումով, ապա մուտք գործեք այստեղ։",
    },
    overview: {
      title: "Ընդհանուր",
      studentsCount: "Աշակերտներ՝ {count}",
      generateCta: "Ստեղծել առաջադրանք",
      manageCta: "Կառավարել աշակերտներին",
      recentTitle: "Վերջին առաջադրանքները",
      emptyState: "Առաջադրանքներ դեռ չկան։",
      unassigned: "Չնշանակված",
    },
    students: {
      title: "Աշակերտներ",
      subtitle:
        "Ավելացրեք աշակերտներին մեկ անգամ, ապա նշանակեք և ստուգեք առաջադրանքներ ըստ անվան։",
      nameLabel: "Աշակերտի անունը",
      notesLabel: "Նշումներ (ընտրովի)",
      addButton: "Ավելացնել աշակերտ",
      addPending: "Ավելացվում է…",
      removeButton: "Հեռացնել",
      emptyState: "Աշակերտներ դեռ չկան — ավելացրեք առաջինը վերևում։",
      errorNameRequired: "Մուտքագրեք աշակերտի անունը։",
    },
    studentHistory: {
      gradingEllipsis: "Ստուգվում է…",
      notSubmitted: "Չի հանձնվել",
      emptyStatePrefix: "Տնային առաջադրանք դեռ նշանակված չէ աշակերտին՝ ",
      emptyStateSuffix: "։",
      generateOneLink: "Ստեղծել առաջադրանք",
    },
    homeworkNew: {
      title: "Նոր առաջադրանք",
      subtitle:
        "Ընտրեք առարկան և թեման — հավասարապես աշխատում է անգլերենի, մաթեմատիկայի, ռուսերենի և ցանկացած այլ առարկայի համար։",
      subjectLabel: "Առարկա",
      subjectPlaceholder: "Ընտրեք առարկան",
      topicLabel: "Թեմա",
      topicPlaceholder: "օրինակ՝ past simple ժամանակաձև, քառակուսի հավասարումներ",
      levelLabel: "Մակարդակ (ընտրովի)",
      levelPlaceholder: "օրինակ՝ սկսնակ, 7-րդ դասարան",
      assignLabel: "Նշանակել աշակերտի (ընտրովի)",
      notAssignedOption: "Դեռ չնշանակված",
      generateButton: "Ստեղծել առաջադրանք",
      generatingButton: "Ստեղծվում է…",
      aiNotConfigured: "ԱԲ-ով ստեղծումը դեռ կարգավորված չէ — անհրաժեշտ է ավելացնել ANTHROPIC_API_KEY։",
      errorChooseSubject: "Ընտրեք առարկան։",
      errorEnterTopic: "Մուտքագրեք առաջադրանքի թեման։",
      errorGenerationFailed: "ԱԲ-ով ստեղծումը ձախողվեց — փորձեք կրկին։",
      errorSaveFailed: "Չհաջողվեց պահպանել առաջադրանքը։",
      errorNotConfigured: "Տնային առաջադրանքների ԱԲ-ով ստեղծումը դեռ կարգավորված չէ։",
    },
    homeworkDetail: {
      levelLabel: "Մակարդակ",
      gradeSectionTitle: "Ստուգել աշխատանքը",
      gradeSectionSubtitle:
        "Վերբեռնեք աշակերտի կատարած աշխատանքը՝ լուսանկար կամ PDF, և ԱԲ-ն կդնի գնահատական, կգրի մեկնաբանություն և կնշի սխալները։",
      aiNotConfiguredGrading:
        "ԱԲ-ով ստուգումը դեռ կարգավորված չէ — անհրաժեշտ է ավելացնել ANTHROPIC_API_KEY։",
      studentLabel: "Աշակերտ",
      chooseStudentPlaceholder: "Ընտրեք աշակերտին",
      fileLabel: "Կատարված աշխատանք (լուսանկար կամ PDF)",
      uploadButton: "Վերբեռնել և ստուգել",
      uploadingButton: "Վերբեռնվում և ստուգվում է…",
      submissionsTitle: "Հանձնված աշխատանքներ",
      unknownStudent: "Անհայտ աշակերտ",
      viewFile: "Բացել ֆայլը",
      notGradedYet: "Դեռ չի ստուգվել։",
      errorNotConfigured: "ԱԲ-ով ստուգումը դեռ կարգավորված չէ։",
      errorChooseStudent: "Ընտրեք, թե որ աշակերտի համար է այս աշխատանքը։",
      errorChooseFile: "Ընտրեք վերբեռնվող ֆայլը։",
      errorFileType: "Վերբեռնեք JPEG, PNG, WebP կամ PDF ֆայլ։",
      errorAssignmentNotFound: "Առաջադրանքը չի գտնվել։",
      errorSaveSubmissionFailed: "Չհաջողվեց պահպանել աշխատանքը։",
      errorGradingFailed: "Ֆայլը վերբեռնվեց, բայց ԱԲ-ով ստուգումը ձախողվեց — փորձեք կրկին։",
    },
    subjects: {
      english: "Անգլերեն",
      math: "Մաթեմատիկա",
