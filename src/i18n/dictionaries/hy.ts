...
const hy: Dictionary = {
  ...
  hero: {
    eyebrow: "Արդյունքի երաշխիք",
    headlineLine1: "Ձեր երեխայի արդյունքը",
    headlineLine2: "ամրագրում ենք պայմանագրում։",
    subheadline:
      "Անվճար կորոշենք մակարդակը, կսահմանենք հասանելի նպատակ և կկազմենք նախապատրաստման ծրագիր։",
    description:
  ...
  footer: {
    ...
    teacherLogin: "Մուտք ուսուցիչների համար",
  ...
  legal: {
    ...
    privacyP2NoEmail:
      "Տվյալները չեն փոխանցվում երրորդ կողմերի, բացառությամբ կրթական ծառայության մատուցման համար անհրաժեշտ դեպքերի։ Կարող եք հայցել ձեր տվյալների ջնջումը՝ դիմելով կենտրոն՝ կայքում նշված կոնտակտներով։",
    termsP1:
